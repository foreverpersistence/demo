package com.learning.fred.design.principle.pattern.action.state.querytable;

import com.learning.fred.design.principle.pattern.action.state.branch.State;

import static com.learning.fred.design.principle.pattern.action.state.branch.State.*;
